...
<p class="my-10 text-sm text-center text-gray-500" x-data="{ year: new Date().getFullYear() }">
    &copy; 2024-<span x-text="year"></span> <a href="https://runacode.dev" class="text-blue-600 underline dark:text-blue-500 hover:no-underline"
        data-popover-target="popover-image">runacode.dev</a>. Todos los derechos reservados.
</p>
...
<div data-popover id="popover-image" role="tooltip"
    ...
    <div class="grid grid-cols-5">
        <div class="col-span-3 p-3">
            <div class="space-y-2">
                <h3 class="font-semibold text-gray-900 dark:text-white">Explora Runacode</h3>
                <p>Todos los contenidos y recursos son propiedad exclusiva de Runacode</p>
                <a href="https://runacode.dev"
                    ...
                    Visita Runacode
                    <svg class="w-2 h-2 ml-1.5" aria-hidden="true"
        ...
        <!-- Imagina que la siguiente imagen es una previsualización dinámica de runacode.dev -->
        <!-- Para obtener una imagen dinámica, podrías usar APIs de captura de pantalla como ScreenshotLayer, Urlbox, etc., o programar tu propio sistema servidor para actualizar esta imagen regularmente. -->
        <img src="URL_TO_DYNAMIC_IMAGE" class="h-full col-span-2" alt="Previsualización de Runacode" />
    </div>

    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <button @click="isSidebarExpanded = !isSidebarExpanded" id="toggleSidebar" aria-expanded="true"
                    ...
                    <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                        ...
                        <div class="px-4 py-3" role="none">
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400" role="none">
                                Role: {{ Auth::user()->role ?? 'No especificado' }}
                            </p>
                        </div>
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                ...
                <a href="#" class="flex ms-2 md:me-24">
                    <img src="" class="h-8 me-3" alt="ACÁ EL LOGO PEPEPE" />
                    <span
                        class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">PERU SAFE TRAVEL</span>
                </a>
            </div>
            <div class="flex items-center">

{{-- <header>
    ...
    <nav x-data="{ atTop: true }" :class="{ 'bg-transparent': atTop, 'bg-white dark:bg-gray-900': !atTop }"
        @scroll.window="atTop = (window.pageYOffset > 50 ? false : true)"
        class="fixed top-0 z-50 w-full transition duration-300 ease-in-out border-gray-200">

        <div class="flex flex-wrap items-center justify-between max-w-screen-xl p-4 mx-auto">
            <a href="{{ url('/') }}" class="flex items-center space-x-3 rtl:space-x-reverse">
                <img src="" class="h-8" alt="o" />
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">..</span>
            </a>

            <div class="flex items-center space-x-1 md:order-2 md:space-x-2 rtl:space-x-reverse">
                <a href="#"
                    class="text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm p-2 md:p-2.5 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">
                    <i class="fas fa-shopping-cart"></i>
                </a>
                @guest
                    <a href="{{ url('/login') }}"
                        class="text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 py-2 md:px-5 md:py-2.5 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">{{ __('Login') }}</a>
                @endguest
                @auth
            ...
            <div id="mega-menu-icons" class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1">
                <ul class="flex flex-col mt-4 font-medium md:flex-row md:mt-0 md:space-x-8 rtl:space-x-reverse">
                    ...
                    <li>
                        <a href="#"
                            class="block px-3 py-2 text-gray-900 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700">
                            {{ __('Tours') }}
                        </a>
                    </li>
                    <li>

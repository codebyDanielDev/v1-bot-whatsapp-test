<x-guest-layout>
    <section>
        <div class="relative flex items-center justify-center text-white bg-center bg-no-repeat bg-cover"
            ...
            <div class="z-10 flex flex-col items-center justify-center p-4 text-center">
                ...
                <h1
                    ...
                    <span
                        class="underline underline-offset-3 decoration-8 decoration-blue-400 dark:decoration-blue-600">CONTACTO</span>
                </h1>
                ...
                <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
                  ...
                  <dl class="mt-10 space-y-4 text-base leading-7 text-gray-300">
                    <div class="flex gap-x-4">
                      ...
                      <dd>Av.Salaverry s/n<br>Lima, Perú</dd>
                    </div>
                    <div class="flex gap-x-4">
                      <dt class="flex-none">
                      ...
                      <dd><a class="hover:text-white" href="tel:+1 (555) 234-5678"> +51 954 318 721</a></dd>
                    </div>
                    <div class="flex gap-x-4">
                      <dt class="flex-none">
                      ...
                      <dd><a class="hover:text-white" href="mailto:hello@example.com">runacodesolution@gmail.com</a></dd>
                    </div>
                  </dl>
                </div>
              </div>
              <form action="#" method="POST" class="px-6 pb-24 pt-20 sm:pb-32 lg:px-8 lg:py-48">
                <div class="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
                  <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                    ...
                    <div>
                      <label for="last-name" class="block text-sm font-semibold leading-6 text-white">Nombre de su empresa</label>
                      <div class="mt-2.5">
        ...
        <!-- Aquí incluye tu contenido de Livewire -->
    </section>

<x-admin-layout :breadcrumbs="[
    ...
    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
        <div
            ...
            @auth
                <h2 class="mt-4 text-xl font-semibold text-gray-800 dark:text-black">Bienvenido, {{ Auth::user()->name }}
                </h2>
                <p class="text-sm text-gray-500 dark:text-gray-400">Tu rol es: <span
                        class="font-semibold">{{ Auth::user()->role->name ?? 'No especificado' }}</span></p>
            @endauth
        ...
        <div
            ...
            <h2 class="text-lg font-semibold text-gray-800 dark:text-white">{{ env('EMPRESA_NOMBRE') }}</h2>
            <h2 class="text-lg font-semibold text-gray-800 dark:text-white">Conéctate con nosotros</h2>
            <div class="flex mt-4 space-x-3">
                <a href="{{ env('FACEBOOK_URL') }}" target="_blank" class="text-blue-600 hover:text-blue-800">
                    <i class="fab fa-facebook-f fa-2x"></i>
                </a>
                <a href="{{ env('INSTAGRAM_URL') }}" target="_blank" class="text-pink-600 hover:text-pink-800">
                    <i class="fab fa-instagram fa-2x"></i>
                </a>
                <a href="{{ env('TWITTER_URL') }}" target="_blank" class="text-blue-400 hover:text-blue-600">
                    <i class="fab fa-twitter fa-2x"></i>
                </a>
                <a href="{{ env('LINKEDIN_URL') }}" target="_blank" class="text-blue-700 hover:text-blue-900">
                    <i class="fab fa-linkedin-in fa-2x"></i>
                </a>
                <a href="{{ env('YOUTUBE_URL') }}" target="_blank" class="text-red-600 hover:text-red-800">
                    <i class="fab fa-youtube fa-2x"></i>
                </a>
                <a href="{{ env('WHATSAPP_URL') }}" target="_blank" class="text-green-500 hover:text-green-700">
    ...
    <div class="grid w-full grid-cols-1 gap-4 mt-4 md:grid-cols-2 xl:grid-cols-3">
        <div class="p-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 dark:bg-gray-800">
            ...
            <!-- Card Footer -->
            <div class="flex items-center justify-between pt-3 border-t border-gray-200 sm:pt-6 dark:border-gray-700">
                <div>
                    <button
                        class="inline-flex items-center p-2 text-sm font-medium text-center text-gray-500 rounded-lg hover:text-gray-900 dark:text-gray-400 dark:hover:text-white"
                        type="button" data-dropdown-toggle="new-products-dropdown">
                        Last 7 days
        ...
        <div class="p-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 dark:bg-gray-800">
            ...
            <div
                ...
                <div>
                    <button
                        class="inline-flex items-center p-2 text-sm font-medium text-center text-gray-500 rounded-lg hover:text-gray-900 dark:text-gray-400 dark:hover:text-white"
                        type="button" data-dropdown-toggle="visitors-dropdown">
                        Last 7 days
                        <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7">
        ...
        <div class="p-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 dark:bg-gray-800">
            ...
            <div class="flex items-center justify-between pt-3 border-t border-gray-200 sm:pt-6 dark:border-gray-700">
                <div>
                    <button
                        class="inline-flex items-center p-2 text-sm font-medium text-center text-gray-500 rounded-lg hover:text-gray-900 dark:text-gray-400 dark:hover:text-white"
                        type="button" data-dropdown-toggle="week-signups-dropdown">
                        Last 7 days
                        <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7">
    ...
    <div class="grid grid-cols-1 my-4 2xl:grid-cols-3 xl:gap-4">
        <div class="p-4 mb-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 dark:bg-gray-800 2xl:col-span-2 xl:mb-0">
            <div class="mb-4">
                ...
                <span class="text-base font-normal text-gray-500 dark:text-gray-400">View website visitors by hovering
                    over the map</span>
            </div>
            ...
            <ul class="space-y-6" role="list">
                    ...
                    <div class="flex items-center mb-3 sm:mb-0">
                        <svg class="w-4 h-4" viewBox="0 0 26 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <defs>
                                ...
                                <linearGradient id="paint0_linear" x1="1.22607" y1="1.67188" x2="1.22607"
                                    y2="7.38616" gradientUnits="userSpaceOnUse">
                        ...
                        <span
                            class="w-32 mx-5 ml-3 text-base font-medium text-gray-900 sm:flex-none dark:text-white">United
                            States</span>
                    </div>
                    <div class="w-full h-5 bg-gray-200 rounded-lg dark:bg-gray-700">
                        <div class="h-5 p-1 text-xs font-bold leading-none text-center rounded-md text-primary-100 bg-primary-700"
                            style="width: 35%">
                            35%
                        </div>
                    </div>
                ...
                <li class="items-center w-full sm:flex">
                    ...
                    <div class="flex items-center mb-3 sm:mb-0">
                        ...
                        <span
                            class="flex-none w-32 mx-5 ml-3 text-base font-medium text-gray-900 dark:text-white">Canada</span>
                    </div>
                    <div class="w-full h-5 bg-gray-200 rounded-lg dark:bg-gray-700">
                        <div class="h-5 p-1 text-xs font-bold leading-none text-center rounded-md text-primary-100 bg-primary-700"
                            style="width: 26%">
                ...
                <li class="items-center w-full sm:flex">
                    ...
                    <div class="flex items-center mb-3 sm:mb-0">
                        ...
                        <span
                            class="flex-none w-32 mx-5 ml-3 text-base font-medium text-gray-900 dark:text-white">France</span>
                    </div>
                    <div class="w-full h-5 bg-gray-200 rounded-lg dark:bg-gray-700">
                        <div class="h-5 p-1 text-xs font-bold leading-none text-center rounded-md text-primary-100 bg-primary-700"
                            style="width: 18%">
                ...
                <li class="items-center w-full sm:flex">
                    ...
                    <div class="flex items-center mb-3 sm:mb-0">
                        ...
                        <span
                            class="flex-none w-32 mx-5 ml-3 text-base font-medium text-gray-900 dark:text-white">Italy</span>
                    </div>
                    <div class="w-full h-5 bg-gray-200 rounded-lg dark:bg-gray-700">
                        <div class="h-5 p-1 text-xs font-bold leading-none text-center rounded-md text-primary-100 bg-primary-700"
                            style="width: 14%">
                ...
                <li class="items-center w-full sm:flex">
                    ...
                    <div class="flex items-center mb-3 sm:mb-0">
                        ...
                        <span
                            class="flex-none w-32 mx-5 ml-3 text-base font-medium text-gray-900 dark:text-white">Australia</span>
                    </div>
                    <div class="w-full h-5 bg-gray-200 rounded-lg dark:bg-gray-700">
                        <div class="h-5 p-1 text-xs font-bold leading-none text-center rounded-md text-primary-100 bg-primary-700"
                            style="width: 10%">
                ...
                <li class="items-center w-full sm:flex">
                    ...
                    <div class="flex items-center mb-3 sm:mb-0">
                        ...
                        <span
                            class="flex-none w-32 mx-5 ml-3 text-base font-medium text-gray-900 dark:text-white">India</span>
                    </div>
                    <div class="w-full h-5 bg-gray-200 rounded-lg dark:bg-gray-700">
                        <div class="h-5 p-1 text-xs font-bold leading-none text-center rounded-md text-primary-100 bg-primary-700"
                            style="width: 7%">
            ...
            <!-- Card Footer -->
            <div
                class="flex items-center justify-between pt-3 mt-6 border-t border-gray-200 sm:pt-6 dark:border-gray-700">
                <div>
                    <button
                        class="inline-flex items-center p-2 text-sm font-medium text-center text-gray-500 rounded-lg hover:text-gray-900 dark:text-gray-400 dark:hover:text-white"
                        type="button" data-dropdown-toggle="sessions-dropdown">
                        Last 7 days
                        <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7">
        ...
        <div class="grid gap-4 sm:grid-cols-2 2xl:grid-cols-1">
            <!-- Top Sales Card -->
            <div class="h-full p-4 mb-4 bg-white rounded-lg shadow sm:p-6 dark:bg-gray-800">
                <div class="flex items-center justify-between mb-4">
                ...
                <div
                    ...
                    <div>
                        <button
                            class="inline-flex items-center p-2 text-sm font-medium text-center text-gray-500 rounded-lg hover:text-gray-900 dark:text-gray-400 dark:hover:text-white"
                            type="button" data-dropdown-toggle="latest-customers-dropdown">
                            Last 7 days
                            <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="p-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 dark:bg-gray-800">
                ...
                <div class="block w-full overflow-x-auto">
                    <table class="items-center w-full bg-transparent border-collapse">
                        <thead>
                            <tr>
                                <th
                                    class="px-4 py-3 text-xs font-semibold text-left text-gray-700 uppercase align-middle border-l-0 border-r-0 rounded-l whitespace-nowrap bg-gray-50 dark:bg-gray-700 dark:text-white">
                                    Top Channels
                                </th>
                                <th
                                    class="px-4 py-3 text-xs font-semibold text-left text-gray-700 uppercase align-middle border-l-0 border-r-0 whitespace-nowrap bg-gray-50 dark:bg-gray-700 dark:text-white">
                                    Users
                                </th>
                                <th
                                    class="px-4 py-3 text-xs font-semibold text-left text-gray-700 uppercase align-middle border-l-0 border-r-0 rounded-r whitespace-nowrap bg-gray-50 min-w-140-px dark:bg-gray-700 dark:text-white">
                                </th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                            <tr class="text-gray-500 dark:text-gray-400">
                                ...
                                <td
                                    class="p-4 px-4 text-xs font-medium text-gray-900 align-middle border-t-0 whitespace-nowrap dark:text-white">
                                    5,649
                                </td>
                ...
                <div
                    ...
                    <div>
                        <button
                            class="inline-flex items-center p-2 text-sm font-medium text-center text-gray-500 rounded-lg hover:text-gray-900 dark:text-gray-400 dark:hover:text-white"
                            type="button" data-dropdown-toggle="aquisitions-dropdown">
                            Last 7 days
                            <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    {{-- Prueba de la tabla de Sesiones --}}
    <div class="p-4 bg-white rounded-lg shadow sm:p-6 xl:p-8 dark:bg-gray-800">
        <!-- Card Title -->
        <div class="flex items-center justify-between mb-4">
            <div>
                ...
                <span class="text-base font-normal text-gray-500 dark:text-gray-400">Últimos inicios de sesión</span>
            </div>
            <div class="flex-shrink-0">
                <a href="#"
                    class="p-2 text-sm font-medium rounded-lg text-primary-700 hover:bg-gray-100 dark:text-primary-500 dark:hover:bg-gray-700">Ver
                    todo</a>
            </div>
        </div>
        <!-- Table -->
                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 w-10 h-10">
                                                <img class="w-10 h-10 rounded-full" src="{{ $login->user->profile_photo_path ?? 'https://via.placeholder.com/50' }}" alt="">
                                            </div>
                                            <div class="ml-4">
                                                <div class="text-sm font-medium text-gray-900">{{ $login->user->name ?? 'Usuario desconocido' }}</div>
                                                <div class="text-sm text-gray-500">{{ $login->user->email ?? 'Correo desconocido' }}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">{{ $login->ip_address }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="inline-flex px-2 text-xs font-semibold leading-5 text-blue-800 bg-blue-100 rounded-full">
                                            {{ $login->city ?? 'Desconocido' }}
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="inline-flex px-2 text-xs font-semibold leading-5 text-purple-800 bg-purple-100 rounded-full">
                                            {{ $login->state_name ?? $login->state ?? 'Desconocido' }}
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 text-sm text-gray-500 whitespace-nowrap">{{ $login->created_at->diffForHumans() }}</td>
                                </tr>
                            @endforeach

    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        sock.ev.on('connection.update', (update) => {
            ...
            if (connection === 'close') {
                ...
                const shouldReconnect = ((_a = error === null || error === void 0 ? void 0 : error.output) === null || _a === void 0 ? void 0 : _a.statusCode) !== baileys_1.DisconnectReason.loggedOut;
        ...
        sock.ev.on('messages.upsert', (m) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!message.key.fromMe && message.key.remoteJid) {
                ...
                yield sock.sendMessage(message.key.remoteJid, {
                    text: 'Hello there!',
                });
            }
        }));
